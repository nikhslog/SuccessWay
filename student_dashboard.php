...
<div class="user-info">
            ...
            <ul class="sidebar-menu">
                <li><a href="student_dashboard.php" class="active">Tableau de bord</a></li>
        ...
        <div class="main-content">
            <h1 class="page-title">Tableau de bord de l'étudiant</h1>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="student_new_application.php" class="new-application-btn">Nouvelle candidature</a>
                </div>
                ...
                <div class="empty-state">
                    ...
                    <a href="student_new_application.php" class="new-application-btn">Commencer votre première candidature</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <script>
        document.getElementById('translationToggle').addEventListener('click', function() {
            window.location.href = 'student_dashboard_en.php';
        });
    </script>
