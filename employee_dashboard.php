...
if (!isset($_SESSION['employee_id']) || !$_SESSION['employee_logged_in'] || $_SESSION['employee_role'] != 'Employee') {
...
// Get all applications sorted by status
$query = "SELECT a.*, s.full_name, s.email, s.phone FROM applications a
          JOIN students s ON a.student_id = s.student_id
          ORDER BY 
            CASE a.status
                WHEN 'Pending' THEN 1
                WHEN 'Under Review' THEN 2
                WHEN 'Sent to University' THEN 3
                WHEN 'Accepted' THEN 4
                WHEN 'Rejected' THEN 5
            END, a.submission_date DESC";
...
<head>
    ...
    <title>Employee Dashboard - SuccessWay</title>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
                <li><a href="employee_dashboard.php" class="active">Dashboard</a></li>
                <li><a href="employee_applications.php">Applications</a></li>
            </ul>
        ...
        <div class="main-content">
            ...
            <div class="status-cards">
                ...
                <div class="status-card">
                    <h3><?php echo $counts['Under Review']; ?></h3>
                    <p>Under Review</p>
                </div>
                <div class="status-card">
                    <h3><?php echo $counts['Sent to University']; ?></h3>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="status-filter">
                        ...
                        <button class="filter-btn" data-status="Sent to University">Sent</button>
