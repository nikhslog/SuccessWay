...
<head>
    ...
    <title>View Application - SuccessWay</title>
        ...
        <div class="main-content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="employee_update_application.php?id=<?php echo $application_id; ?>" class="action-button">
            ...
            <div class="card">
                ...
                <div class="status-timeline">
                    ...
                    <?php if ($history->num_rows > 0): ?>
                        ...
                        <div class="timeline-item">
                            <div class="timeline-dot">
                                <?php if ($update['new_status'] == 'Accepted'): ?>
                                    <i class="fas fa-check"></i>
                                <?php elseif ($update['new_status'] == 'Rejected'): ?>
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-date">
                                    <?php echo date('F d, Y \a\t h:i A', strtotime($update['update_date'])); ?> by <?php echo htmlspecialchars($update['employee_name']); ?>
                                </div>
                            </div>
                        </div>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <div class="timeline-item">
                            ...
                            <div class="timeline-content">
                                <div class="timeline-status">No status updates yet</div>
                                <div class="timeline-date">Application is in its initial state</div>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
